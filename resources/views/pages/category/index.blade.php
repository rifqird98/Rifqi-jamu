                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('category.store') }}" method="POST">
                                    ...
                                    <textarea name="deskripsi" cols="30" rows="10" class="form-control">Deskripsi</textarea>
                        ...
                        <tbody>
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td>
                                        <textarea class="form-control" cols="30" rows="10">{{ $item->deskripsi }}</textarea>
                                    </td>
                                    <td>
                                        <div class="dropdown">
                                ...
                                @include('pages.model.editcategory')
                            @endforeach
